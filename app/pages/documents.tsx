  ...
  ducoments: [
    {
      ...
      document_accrediation_type:
        'Calibration Lab,Halal Product Certification ,Inspection Body ,Management System Certification ,Medical Lab ,Personnel Certification Body ,Product Certification ,Prof Testing Provider ,Reference Material Producer,Testing Lab',
      document_changelog:
        'Minor update in relation to internal audit finding 2021 to add a sentence that the CAB is "(normally those Conformity Assessment Bodies covered by IAF MLA)"',
