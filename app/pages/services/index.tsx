  ...
  services: [
    {
      ...
      service_desc_ar:
        'نقدم في شركة كاسكو خدمات استشارية في مجال مختبرات الفحص، وذلك وفقًا للمواصفة القياسية الدولية ISO/IEC 17025:2017.',
    },
    {
      service_id: 1,
      service_name: 'Calibration Laboratory Consultation',
      service_desc:
        'At CASCO, we provide consultation services in the field of calibration laboratories, in accordance with the international standard ISO/IEC 17025:2017.',
      ...
      service_desc_ar:
        'نقدم في شركة كاسكو خدمات استشارية في مجال مختبرات المعايرة، وذلك وفقًا للمواصفة القياسية الدولية ISO/IEC 17025:2017.',
    },
    {
      service_id: 2,
      service_name: 'Inspection Certification Body Consultation',
      service_desc:
        'At CASCO, we provide consultation services in the field of inspection body accreditation, in accordance with the international standard ISO/IEC 17020:2012.',
      ...
      service_desc_ar:
        'نقدم في شركة كاسكو خدمات استشارية في مجال اعتماد جهات التفتيش، وذلك وفقًا للمواصفة القياسية الدولية ISO/IEC 17020:2012.',
    },
    {
      service_id: 3,
      ...
      service_desc_ar:
        'نقدم في شركة كاسكو خدمات استشارية في مجال منح الشهادات للمنتجات، وذلك وفقًا للمواصفة القياسية الدولية ISO/IEC 17065:2012.',
    },
    {
      service_id: 4,
      service_name: 'Management System Certification Body Consultation',
      service_desc:
        'At CASCO, we provide consultation services in the field of management system certification body accreditation, in accordance with the international standard ISO/IEC 17021-1:2015.',
      ...
      service_desc_ar:
        'نقدم في شركة كاسكو خدمات استشارية في مجال منح شهادات النظم الإدارية، وذلك وفقًا للمواصفة القياسية الدولية ISO/IEC 17021-1:2015.',
    },
    {
      service_id: 5,
      ...
      service_desc_ar:
        'نقدم في شركة كاسكو خدمات استشارية في مجال المختبرات الطبية، وذلك وفقًا للمواصفة القياسية الدولية ISO 15189:2012.',
    },
    {
      service_id: 6,
      ...
      service_desc_ar:
        'نقدم في شركة كاسكو خدمات استشارية في مجال منح شهادات الحلال، وذلك وفقًا للمواصفة القياسية الدولية GSO 2055-2:2021.',
    },
    {
      service_id: 7,
      service_name: 'Personal Certification Consultation',
      service_desc:
        'At CASCO, we provide consultation services in the field of Personal certification, in accordance with the international standard ISO/IEC 17024:2012.',
      service_image: '../public/images/services_images/1.jpg',
      service_link: 'personal-certification-consultation',
      services_name_ar: 'استشارة جهات منح الشهادات للأفراد',
      service_desc_ar:
        'نقدم في شركة كاسكو خدمات استشارية في مجال منح الشهادات للأفراد، وذلك وفقًا للمواصفة القياسية الدولية ISO/IEC 17024:2012.',
    },
    {
      service_id: 8,
      service_name: 'Consultation for Proficiency Testing Providers',
      service_desc:
        'At CASCO, we provide consulting services in the field of proficiency testing providers in accordance with the international standard ISO/IEC 17043:2010.',
      service_image: '../public/images/services_images/2.jpg',
      service_link: 'consultation-for-proficiency-testing-providers',
      services_name_ar: 'استشارة الجهات المزودة لاختبارات الكفاءة',
      service_desc_ar:
        'نقدم في شركة كاسكو خدمات استشارية في مجال الجهات المزودة لاختبارات الكفاءة، وذلك وفقًا للمواصفة القياسية الدولية ISO/IEC 17043:2010.',
    },
    {
      service_id: 9,
      ...
      service_desc_ar:
        'نقدم في شركة كاسكو خدمات استشارية في عمليات التقييم الفني بغرض التأهيل للحصول على التعيين للجهات المانحة لشهادات مطابقة المنتجات الواردة في اللوائح الفنية الخليجية وذلك وفقا للائحة لعب الاطفال و لائحة الأجهزة الكهربائية منخفضة الجهد وغيرها.',
    },
    {
      service_id: 10,
      ...
      services_name_ar:
        'استشارة الحصول على شهادة تجار التجزئة بالمملكة المتحدة British Retail Consortium  -BRCGS ',
      service_desc_ar:
        'نقدم في شركة كاسكو خدمات استشارية في عمليات التأهيل للحصول على شهادة BRCGS Food Safety وBRCGS Packaging Material  ',
    },
    {
      service_id: 11,
      service_name:
        'Consultation for Obtaining Forest Stewardship Council (FSC) Certification',
    ...
    },
    {
      ...
      service_desc_ar:
        'نقدم في شركة كاسكو خدمات استشارية في مجال FSSC 22000 - اعتماد نظام سلامة الأغذية والأعلاف وأنظمة إدارة الجودة بما يتوافق مع متطلبات ISO22000 / 9001 ومتطلبات برنامج المتطلبات الأساسية للقطاع ومتطلبات البرنامج الإضافية تبعا ، وذلك وفقًا للمواصفة القياسية الدولية  FSSC 22000 Version 6.0 للحصول على مصادقة GFSI.',
    },
    {
      service_id: 13,
      service_name: 'ESG Report Service',
      service_desc:
        'CASCO offers a low-cost and credible ESG report service for businesses in the Gulf region, leveraging our team of highly experienced advisors with in-depth knowledge of ESG standards, regulations, and best practices across all major jurisdictions.',
      service_image: '../public/images/services_images/7.jpg',
      service_link: 'esg-report-service',
      services_name_ar: '14- خدمة تقارير ESG',
      service_desc_ar:
        'تقدم شركة كاسكو خدمة تقارير ESG بتكلفة منخفضة وموثوقة للشركات في منطقة الخليج، باستخدام فريق مستشارين ذوي خبرة عالية يتمتعون بمعرفة عميقة بمعايير ESG واللوائح وأفضل الممارسات في جميع الولايات الرئيسية',
    },
  ],
};
