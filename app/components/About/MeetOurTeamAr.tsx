...
const MeetOurTeamAr: React.FC<Props> = ({ teams }) => {
  return (
    <>
      <section
        ...
        <div className="container card-grid">
          <div className="row">
            <div className="col-12 text-center">
              <h2 className="title title--lg red-1-color">تعرف على فريقنا</h2>
            </div>
          </div>
                    ...
                    <div className="row no-gutters">
                      <div className="col-6">
                        <div className="card__content">
                          <div className="title title--sm">{t.name_ar}</div>
