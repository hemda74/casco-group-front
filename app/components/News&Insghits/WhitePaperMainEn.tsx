      ...
      <div id="content-wrap">
        ...
        <div className="container card-grid">
          <div className="row pad-40-vert">
            ...
            <div className="col-md-4">
              <a href="https://www.argonandco.com/en/news-insights/whitepapers/business-leaders-must-maximise-the-chance-of-success-when-engaging-in-business-transformation-projects/">
                <div className="card  card--large  red-5-background">
                  <div className="card__category">Whitepaper </div>
                  <div className="position-bottom">
                    <div className="card__content">
            ...
            <div className="col-md-4">
              <a href="https://www.argonandco.com/en/news-insights/whitepapers/sop-are-you-making-the-most-of-it/">
                <div className="card  card--large  red-5-background">
                  <div className="card__category">Whitepaper </div>
                  <div className="position-bottom">
                    <div className="card__content">
            ...
            <div className="col-md-4">
              <a href="https://www.argonandco.com/en/news-insights/whitepapers/the-business-benefits-of-aps-systems-as-clear-as-abc/">
                <div className="card  card--large  red-5-background">
                  <div className="card__category">Whitepaper </div>
                  <div className="position-bottom">
                    <div className="card__content">
            ...
            <div className="col-md-4">
              <a href="https://www.argonandco.com/en/news-insights/whitepapers/nearly-a-third-of-all-supply-chain-processes-are-inadequate/">
                <div className="card  card--large  red-5-background">
                  <div className="card__category">Whitepaper </div>
                  <div className="position-bottom">
                    <div className="card__content">
            ...
            <div className="col-md-4">
              <a href="https://www.argonandco.com/en/news-insights/whitepapers/pharmaceutical-supply-chains-must-be-brutal-and-go-back-to-core-principles-says-crimson-co/">
                <div className="card  card--large  red-5-background">
                  <div className="card__category">Whitepaper </div>
                  <div className="position-bottom">
                    <div className="card__content">
