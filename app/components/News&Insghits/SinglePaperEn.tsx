        ...
        <div className="container">
          <div className="row small-gutters pad-40-vert">
            <div className="col-lg-4 col-md-6 pad-30-pad">
              <a href="https://www.argonandco.com/en/news-insights/whitepapers/digital-transformation-the-huge-data-flood-is-on-your-doorstep-your-survival-kit-for-staying-afloat/">
            ...
            <div className="col-lg-4 col-md-6 pad-30-pad">
              <a href="https://www.argonandco.com/en/news-insights/whitepapers/rise-or-fall-how-businesses-are-responding-to-high-inflation/">
                <div className="card  card--large  red-5-background">
                  <div className="card__category">Whitepaper </div>
                  <div className="position-bottom">
                    <div className="card__content">
            ...
            <div className="col-lg-4 col-md-6 pad-30-pad">
              <a href="https://www.argonandco.com/en/news-insights/whitepapers/boosting-productivity-whitepaper/">
                <div className="card  card--large  red-5-background">
                  <div className="card__category">Whitepaper </div>
                  <div className="position-bottom">
                    <div className="card__content">
