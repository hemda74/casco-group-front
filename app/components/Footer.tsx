        ...
        <div className="row d-flex justify-content-center ms-2 me-2">
          <div className="col-md-6 col-lg-3   ">
            <div className="info">
              ...
              <small
                className={`mt-4 d-inline-block ${styels.companybrief}`}
          ...
          <div className="col-md-6 col-lg-2 pt-3">
            ...
            <div className="links">
              <span
                className={`fs-6 fw-bold ${styels.footerLink}`}
                ...
                <div className="form-group">
                  <div className="form-group">
                    ...
                    <div className={` mt-2 ${styels.iconsSocial}`}>
                      <Link href={'/'}>
                        <a className={` me-2 ms-2 ${styels.footerA}`}>
                          {' '}
                          <BsTwitter size={15} />
                        </a>
                      </Link>
