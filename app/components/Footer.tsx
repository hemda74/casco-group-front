      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-3">
            ...
            <address>
              ...
              United Kingdom
              <br />
              <a href="mailto:uk@argonandco.com">uk@argonandco.com</a>
              <br />
              +44 (0) 845 644 6972{' '}
            </address>
            <div className="social-links">
              <a
                ...
                href="https://www.linkedin.com/company/argon-co/"
                title="linkedin"
                target="_blank">
                <img
                  width="30"
                  height="30"
                  src="https://www.argonandco.com/wp-content/themes/ArgonCo/assets/img/social/linkedin_white_circle.svg"
                  alt="linkedin Icon"
                />
              </a>{' '}
            </div>
        ...
        <div className="row copyright-footer no-gutters">
          ...
          <div className="col-md-5 text-right">
            {' '}
            <a className="intro" href="https://portoflio-drab.vercel.app/">
              Web Design by{' '}
            </a>{' '}
            <a className="intro" href="https://portoflio-drab.vercel.app/">
              Ahmed Hemdan
